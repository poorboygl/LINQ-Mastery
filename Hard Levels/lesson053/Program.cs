...
class Program
{
    static void Main()
    {
        ...
        //customerRepository.GetPurchasingTrendsByRegion(out test);
        ...
        foreach (var summary in summaries)
        {
            ...
            Console.WriteLine($"Avg Spending / Customer: {summary.AverageSpendingPerCustomer}");
        }
...
public class CustomerRepository
{
    ...
    public void GetPurchasingTrendsByRegion(out List<object> result)
    {
        result = [.. Regions
            .GroupJoin(Customers,
                region => region.Id,
                ...
                (region, regionCustomers) => new
                {
                    ...
                    Customers = regionCustomers.Select(c => c.Id).Distinct(),
                    Purchases = regionCustomers
                       .SelectMany(customer => Purchases.Where(p => p.CustomerId == customer.Id)) //Lấy danh Sách Purchase theo customerID
                        .ToList()
                })];
    }
}
...
Avg Spending / Customer: 325

Region: South
Total Customers: 1
Total Purchases: 1
Total Amount Spent: 500
Avg Spending / Customer: 500
