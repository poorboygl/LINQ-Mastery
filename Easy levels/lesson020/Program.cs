class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("All products in all orders:");
...
* 1.Using SelectMany for Flattening:

SelectMany(order => order.Products) flattens all Products from each Order into a single sequence of Product objects.

* 2.Converting to a List of Products:

The result of SelectMany is converted to List<Product> using ToList() to match the return type.
